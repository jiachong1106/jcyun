    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          <div><a class="navbar-brand" href="index.html" style="font-size:32px;">甲壳虫云—资源分享网</a></div>
        </div>
      </div>
    </nav>
      ...
      <form id="loginForm"  method="POST" class="form-signin" role="form">
        ...
        <h2 class="form-signin-heading"><i class="glyphicon glyphicon-log-in"></i> 用户登录</h2>
		  <div class="form-group has-success has-feedback">
			<input type="text" class="form-control" id="floginacct" name="loginacct" value="jc" placeholder="请输入登录账号" autofocus>
